...
def evaluate_predictions(df):
    ...
    for race_name, race_df in df.groupby("RaceName"):
        ...
        actual_winner = race_df[
            race_df["FinishPosition"] == 1
        ].iloc[0]["Driver"]
    ...
    return {
        "top1_accuracy": round(
            100 * top1_correct / total_races,
            2
        ),
        "top3_accuracy": round(
            100 * top3_correct / total_races,
            2
        ),
...
season_2023 = season_2023[
    season_2023["Race"] != "Pre-Season Testing"
]
...
results_table["PredictedPosition"] = (
    results_table["PredictedPosition"]
    .round(2)
)
...
print(
    f"Top-1 Accuracy: "
    f"{metrics['top1_accuracy']}%"
)

print(
    f"Top-3 Accuracy: "
    f"{metrics['top3_accuracy']}%"
)

print(
    f"Races Evaluated: "
    f"{metrics['total_races']}"
)
