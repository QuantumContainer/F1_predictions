...
model23, results23, mae23, metrics23 = (
    run_backtest(
        season_2022,
        season_2023
    )
...
model24, results24, mae24, metrics24 = (
    run_backtest(
        history_22_23,
        season_2024
    )
...
model25, results25, mae25, metrics25 = (
    run_backtest(
        history_22_24,
        season_2025
    )
    ...
    [
        {
            ...
            "Top1":
                metrics23["top1_accuracy"],

            "Top3":
                metrics23["top3_accuracy"]
        },

        {
            ...
            "Top1":
                metrics24["top1_accuracy"],

            "Top3":
                metrics24["top3_accuracy"]
        },

        {
            ...
            "Top1":
                metrics25["top1_accuracy"],

            "Top3":
                metrics25["top3_accuracy"]
        }
    ]
)
